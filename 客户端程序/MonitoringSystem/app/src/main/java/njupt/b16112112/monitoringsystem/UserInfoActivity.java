...
import njupt.b16112112.monitoringsystem.bean.UserBean;
import njupt.b16112112.monitoringsystem.utils.AnalysisUtils;
import njupt.b16112112.monitoringsystem.utils.DBUtils;
...
public class UserInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initData() {
        ...
        if (bean == null) {
            ...
            bean.nickName="冷链运输管理员";
            bean.sex="女";
            bean.signature="冷链运输管理我最强";
            //保存用户信息到数据库
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_signature://签名的点击事件
                ...
                bdSignature.putString("title", "信息");
